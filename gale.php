            ...
            <div class="col-md-12 mt-4">
                <div class="card">
                    <div class="card-header">
                        <h3><b>Base Name: GALE CRATERTOWN</b></h3><br>
                        
                    </div>
                    <div class="card-body">
                        <h5><b>Base Leader: MARK WATNEY</b><br>
                        <b>Number of Members: <?php echo $count3; ?></b></h5>
                            ...
                            <tbody>
                                <?php
                                    $query = 'SELECT s.supply_id, s.name, s.description, i.quantity
                                                FROM (SELECT * FROM inventory where base_id=3) as i
